            ...
            <div className={styles['footer-inner-container']}>
                    ...
                    <div className={styles['footer-container-2']}>
                        ...
                        <div>
                            ...
                            <div className={styles['footer-social-media-icons']}>
                                <a href='https://www.facebook.com/' target='blank'> <img src={iconFacebook} alt="icon-facebook"/></a>
                                <a href='https://www.instagram.com/' target='blank'><img className={styles['footer-social-icon']} src={iconInstagram} alt="icon-instagram"/></a>
                                <a href='https://twitter.com/?lang=en' target='blank'> <img src={iconTwitter} alt="icon-twitter"/></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className={styles['footer-container-3']}>
                    <ul>
                        ...
                        <li className={'footer-list-items'}>
                            <a href='https://www.strava.com/login' target='blank'
